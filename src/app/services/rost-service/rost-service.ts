...
export class RostService extends GostServiceBaseClass<
  NavMembersByHeadingQuery,
  NavMembersByHeadingGQL,
  FindOneNavQuery,
  FindOneNavGQL,
...
//   providedIn: 'root',
// })
// export class RostService extends GostServiceBaseClass<NavMembersByHeadingQuery> {
//   constructor(
//     private nam1: NameService,
//     private postsGql: NavMembersByHeadingGQL,
//   ) {
...
//   // override posts: Query<PostsInCollectionQuery, any>;
...
//     PostsInCollectionQuery | DeepPartial<PostsInCollectionQuery> | undefined
//   > {
//     // ): Observable<PostsInCollectionQuery> {
//     return this.posts
//       .watch({
//         variables: {
//           collectionId,
